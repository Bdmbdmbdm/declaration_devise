			    			...
			    			<tr>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Nom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</label>
				                		*<input type="text" name="nomv" class="form-control input-sm bordcol control" placeholder="Nom" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" style="width: 40%;" required="required">
			    					</div>
			    				</td>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Prénom &nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</label>
				                		*<input type="text" name="pren" class="form-control input-sm control" placeholder="Prénom" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" style="width: 40%;" required="required">
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Profession : &nbsp;&nbsp;</label>
				               			*<input type="text" name="prof" class="form-control input-sm control" placeholder="Profession" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" style="width: 40%;" required="required"><br>
			    					</div>
			    				</td>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Nationalité : &nbsp;&nbsp;</label>
				               			*<input onkeyup="fonc()" id="nat" type="text" name="nat" class="form-control input-sm control" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" placeholder="Nationalité" style="width: 40%;" required="required"><br>
			    						<script>
					    					function fonc(){
			    				...
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%; margin-bottom: 1%;">
				    					<label>Adresse en Algérie &nbsp;&nbsp;:</label>
				               			<input id="id" type="text" name="adr_a" class="form-control input-sm control" placeholder="Adresse en Algérie" style="margin-left: 2.5%; width: 61.5%;" required>
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%; margin-bottom: 1%;">
				    					<label>Adresse à l'étranger : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
				               			<input id="id1" type="text" name="adr_e" class="form-control input-sm control" placeholder="Adresse à l'étranger" style="width: 61.5%;" required>
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%;">
				    					<label>N° Passeport / Carte de résidence : &nbsp;</label>
				               			*<input type="text" name="np" class="form-control input-sm control" placeholder="N° Passeport / Carte de résidence" style="width: 51%;" required="required">
			    					</div>
			    				</td>
			    			</tr>
			    		</table>
					 				...
					 				<div>
						 				...
						 				<div class="col-md-6">
						 					<div class="col-md-6">
							 					...
							 					<input type="Number" name="vc" style="width: 100%; margin-bottom: 2%;" id="invisible" required min="1000"><br>
	...
	if (isset($_POST['confirmer'])) {
		...
		if($date1 > $date2){
			...
			if(mysqli_num_rows($result) > 0)  {  
				...
				if($id_user != 'non'){
					...
					if($etat == "sortie"){
						...
						echo "<script type='text/javascript'>if (confirm('veulliez vous vraiment modifier cette formulaire ! ')){alert('Valider');}</script>";						
							...
							$sql5="SELECT * FROM apurement WHERE id_formulaire=$id2";
							...
							if($result->num_rows>0){
								while($row=$result->fetch_assoc()){
									if ($v4 == "algerien"){
										...
										$sql="UPDATE apurement SET id_formulaire='$id2',id_utilisateur='non', date_ap='2000-01-01'";
										mysqli_query($conn, $sql);
									}
								}
							}else{
								if ($v4 == "algerien"){
									$sql="UPDATE etat SET id_formulaire='$id2', etat='entree'";
									mysqli_query($conn, $sql);
								}else{
									$sql="INSERT INTO apurement(id_formulaire,id_utilisateur, date_ap) VALUES ('$id2','non','2000-01-01')";
									mysqli_query($conn, $sql);
								}
							}
				...
				$sql6="INSERT INTO `change` (`id_formulaire`, `date_e`, `montant`, `nature`, `nature2`, `montant2`, `date_e2`, `image`, `image_ap`) VALUES ('$id2', '2000-01-01', '0', '0', '0', '0', '2000-01-01', NULL, NULL);";

...
<head>
	...
	<title>
		Validation à la sortie d'un résident
	</title>
</head>
 ...
 $servername = "localhost";
	...
	if (isset($_POST['submit'])) {
		...
		if($result->num_rows>0){
			...
			if($etat == "entree"){
				...
				$sql3="SELECT nature, nature2, montant, montant2, date_c, date_c2 FROM echang WHERE id_formulaire=$id_form";
				...
				if($result->num_rows>0){
					while($row=$result->fetch_assoc()){
						...
						$c4 = $row['montant2'];
						$_POST['mont2_cd']=$c4;
						if($row['date_c']!="2000-01-01") 
							$c5 = strftime('%Y-%m-%d',strtotime($row['date_c']));
						else
							$c5 = "";
						$_POST['date1_cd']=$c5;
	
						if($row['date_c2']!="2000-01-01") 
							$c6 = strftime('%Y-%m-%d',strtotime($row['date_c2']));
						else 
							$c6 = "";
						$_POST['date2_cd']=$c6;
					}
	...
	if (isset($_POST['valider'])) {
		...
		if($result->num_rows>0){
			...
			if($etat == "entree"){
				...
				if($result->num_rows>0){
					while($row=$result->fetch_assoc()){
						...
						$c3 = $row['montant'];
						$c4 = $row['montant2'];
						$c5 = $row['date_c'];if ($c5=='2000-01-01') $c5='';
						$c6 = $row['date_c2'];if ($c6=='2000-01-01') $c6='';				
					}
				}else{
					$c1 = '0';
					$c2 = '0';
					...
					$c5 = '2000-01-01';
					$c6 = '2000-01-01';
					$sql6="INSERT INTO `echang`(nature, nature2, montant, montant2, date_c, date_c2, id_formulaire) VALUES('$c1','$c2','$c3','$c4','$c5','$c6','$id_form')";
					mysqli_query($conn, $sql6);

					$c5='';
					$c6='';
				}//echo $_POST['date1_cd'].' '.$c5;
				...
				if ($_POST['nomv']==$n && $_POST['pren']==$n1 && $_POST['prof']==$n2 && $_POST['nat']==$n3 &&
					...
					$_POST['nature_cd']==$c1 && $_POST['nature2_cd']==$c2 && $_POST['mont_cd']==$c3 && $_POST['mont2_cd']==$c4 && $_POST['date1_cd']==$c5 && $_POST['date2_cd']==$c6)
				{
					...
					if($justif == "" || $observ == ""){
						...
						if($date1 > $date2){
							...
							echo "<script type='text/javascript'>if (confirm('veulliez vous vraiment modifier cette formulaire ! ')){alert('Valider');}</script>";						
								...
								$sql5="UPDATE `echang` SET nature='$c12', nature2='$c22', montant='$c32', montant2='$c42', date_c='$c52', date_c2='$c62' WHERE id_formulaire=$id_form";
			...
			echo "<script type='text/javascript'>alert('cette formulaire n\'exist pas veulliez l\'inseré à nouveau');</script>";
		}
	...
	<div class="container">
		<div class="panel panel-default">
			...
			<p class="coul" align="center">
				<b>Validation à la sortie d'un résident</b>
			</p>
		</div>
	</div>
	<style type="text/css">

        	...
        	<div class="panel panel-default">
			   ...
			   <div class="container">
					 			...
					 			<div class="panel-body">
					 				<div class="container" id="principal">
					 					<div class="row" style="margin-left: 3%; margin-bottom: 3%;">
				                			...
				                			<div class="char">
				                			<!--<span id="char" class="glyphicon glyphicon-remove" style="color:#FF0004;">
				                			</span>-->
				                			</div>
	    			...
	    			<div class="container">
					 ...
					 <div align="center">
					 <button class="btn btn-success btn-sm" id="impr" onclick="onclickswal()" style="cursor:pointer;" type="submit" name="confirmer" > Confirmer </button>
					</div>
		...
		if($date1 > $date2){
			...
			if(mysqli_num_rows($result) > 0)  {  
				...
				if($id_us != 'non'){
					...
					if($etat == "sortie"){
						...
						echo "<script type='text/javascript'>if (confirm('veulliez vous vraiment modifier cette formulaire ! ')){alert('Valider');}</script>";						
							...
							$sql5="UPDATE `change` SET `nature`='$n12', `nature2`='$n22', `montant`='$n3', `montant2`='$n4', `date_e`='$n52', `date_e2`='$n62' WHERE `change`.`id_formulaire`=$id_form";
							$conn->query($conn, $sql5) or die("Error: ".mysqli_error($conn));
				...
				if ($v4 == "algerien"){
					...
					$sql="INSERT INTO apurement(id_formulaire,id_utilisateur, date_ap) VALUES ('$id2','$id_user','2000-01-01')";
					mysqli_query($conn, $sql);
				}
				...
				$sql6="INSERT INTO `change` (`id_formulaire`, `date_e`, `montant`, `nature`, `nature2`, `montant2`, `date_e2`, `image`, `image_ap`) VALUES ('$id2', '$n52', '$n32', '$n12', '$n22', '$n42', '$n62', NULL, NULL);";

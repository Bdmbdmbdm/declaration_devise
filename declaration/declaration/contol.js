...
required="required" pattern="[A-Z]{1}[a-z]+" title="exp : Nom"
required="required" pattern="[A-Z]{1}[a-z]+" title="exp : Prénom"
 required="required" pattern="[A-Z]{1}[a-z]+" title="exp : Profession"
 required="required" pattern="[A-Z]{1}[a-z]+" title="exp : Nationalité"
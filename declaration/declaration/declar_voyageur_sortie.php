			    			...
			    			<tr>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Nom &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</label>
				                		*<input type="text" name="nomv" class="form-control input-sm control" placeholder="Nom" style="width: 40%;" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" required="required">
			    					</div>
			    				</td>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Prénom &nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;</label>
				                		*<input type="text" name="pren" class="form-control input-sm control" placeholder="Prénom" style="width: 40%;" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" required="required">
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Profession : &nbsp;&nbsp;</label>
				               			*<input type="text" name="prof" class="form-control input-sm control" placeholder="Profession" style="width: 40%;" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" required="required"><br>
			    					</div>
			    				</td>
			    				<td>
			    					<div class="row" style="margin-left: 5%; margin-bottom: 1%;">
				    					<label>Nationalité : &nbsp;&nbsp;</label>
				               			*<input id="nat" onkeyup="fonc()" type="text" name="nat" class="form-control input-sm control" placeholder="Nationalité" pattern="[A-Z ]{1}[a-z ]+|[a-z ]+|[A-Z ]+" style="width: 40%;" required="required"><br>
			    						<script>
					    					function fonc(){
			    				...
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%; margin-bottom: 1%;">
				    					<label>Adresse en Algérie &nbsp;&nbsp;:</label>
				               			<input id="id" type="text" name="adr_a" class="form-control input-sm control" placeholder="Adresse en Algérie" pattern="[^(&§!?{$¤£<'>}_=+[°|#~@µ]%)]|[/]" style="margin-left: 2.5%; width: 61.5%;" required>
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%; margin-bottom: 1%;">
				    					<label>Adresse à l'étranger : &nbsp;&nbsp;&nbsp;&nbsp;</label>
				               			<input id="id1"type="text" name="adr_e" class="form-control input-sm control" placeholder="Adresse à l'étranger" pattern="[^(&§!?{$¤£<'>}_=+[°|#~@µ]%)]|[/]" style="width: 61.5%;" required>
			    					</div>
			    				</td>
			    			</tr>
			    			<tr>
			    				<td colspan="2">
			    					<div class="row" style="margin-left: 2.5%;">
				    					<label>N° Passeport / Carte de résidence : &nbsp;</label>
				               			*<input type="text" name="np" class="form-control input-sm control" placeholder="N° Passeport / Carte de résidence" pattern="\d{2}[A-Z]{2}\d{5}|\d{9}" style="width: 51%;" required="required">
			    					</div>
			    				</td>
			    			</tr>
			    		</table>
		...
		if($date1 > $date2){
			...
			if($v4 != "algerien"){
				...
				if(mysqli_num_rows($result) > 0)  {  
					...
					$sql6="INSERT INTO `echang` (`id_formulaire`, `date_c`, `montant`, `nature`, `nature2`, `montant2`, `date_c2`, `image`) VALUES ('$id2', '2000-01-01', '0', '0', '0', '0', '2000-01-01', NULL);";
